  ...
  <div>
        ...
        <div class="relative flex-1 flex flex-col max-w-xs w-full bg-white">
          ...
          <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <div class="flex-shrink-0 flex items-center px-4">
              ...
              <span class="text-primary font-bold text-xl">Shipper</span>
            </div>
          ...
          <div class="flex-shrink-0 flex border-t border-gray-200 p-4">
            <div class="flex-shrink-0 group block">
              <div class="flex items-center">
                ...
                <div class="ml-3">
                  <p class="text-base font-medium text-gray-700">{{ user?.name || 'Shipper' }}</p>
                  <button
                    @click="logout"
        ...
        <div class="flex-shrink-0 flex border-t border-gray-200 p-4">
          <div class="flex-shrink-0 w-full group block">
            <div class="flex items-center">
              ...
              <div class="ml-3">
                <p class="text-sm font-medium text-gray-700">{{ user?.name || 'Shipper' }}</p>
                <button
                  @click="logout"
    ...
    <div class="sticky top-0 z-10 lg:hidden bg-white pl-1 pt-1 sm:pl-3 sm:pt-3 flex">
      ...
      <div class="flex items-center ml-2">
        <img class="h-8 w-auto mr-2" src="@/assets/images/logo.svg" alt="Food Delivery" />
        <span class="text-primary font-bold">Shipper Dashboard</span>
      </div>
    </div>
  </div>
</template>
...
const userInitials = computed(() => {
  if (!user.value || !user.value.name) return 'S';
...
const navigation = [
  { id: 'dashboard', name: 'Dashboard', to: '/shipper', icon: HomeIcon },
  { id: 'deliveries', name: 'My Deliveries', to: '/shipper/deliveries', icon: TruckIcon },
  { id: 'profile', name: 'My Profile', to: '/shipper/profile', icon: UserIcon },
];
